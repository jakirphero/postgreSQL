...
--     4. Performance: Can sometimes offer better performance for simple operations due to the optimized query execution plans generated by
...
-- how to create PROCEDURE to pass parameter
CREATE Procedure remove_emp_by_id(p_em_id INT)
LANGUAGE plpgsql
as 
$$
    DECLARE
    ...
    BEGIN
        ...
        RAISE NOTICE 'delete successfully!';
    END
$$;

call remove_emp_by_id(20);
