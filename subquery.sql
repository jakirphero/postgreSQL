...
-- SELECT max(salary) FROM employees WHERE department_name = 'IT';
SELECT salary FROM employees WHERE department_name = 'IT';

SELECT * FROM employees WHERE salary > (SELECT max(salary) FROM employees WHERE department_name = 'IT'); --nested query